...
def addTask(): #FOR ADDING THE TASK INTO THE WINDOW
    task = task_entry.get()
...
def deleteTask(): # TO DELETE A SELECTED TASK
    global task_list
...
def openTaskFile():
    ...
    try:  # IF THERE ALLREADY EXISTS A TASKFILE.TST FILE THE WRITE OVER IT ORELSE OPEN THE FILE IN WRITE MODE AND THEN WRITE
        global task_list
